...
//        BusPartner busPartnerDb = this.busPartnerService.findById(busType.getBusPartner().getId());
    ...
    @Override
    public ResBusType findById(int id) throws IdInvalidException {
    ...
    @Override
    public ResBusType updateBusType(BusType busType) throws IdInvalidException {
    ...
    @Override
    public ResultPaginationDTO getAllBusTypes(Specification<BusType> specification, Pageable pageable) {
        Page<BusType> busTypePage = this.busTypeRepository.findAll(specification, pageable);
