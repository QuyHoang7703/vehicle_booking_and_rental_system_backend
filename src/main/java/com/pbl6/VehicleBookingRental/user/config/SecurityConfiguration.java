...
//                "/hello",
                ...
                "/ws/**",
                "/api/user/vehicle-register/all",
                "/api/user/vehicle-register/get-vehicle-register",
                "/api/user/vehicle-register/get-exist-filter-properties",
                "/api/user/vehicle-register/get-vehicle-rental-service",
                "/api/user/vehicle-register/get-vehicle-register",
                "/api/v1/user/busTripSchedules/**",
                "/api/user/vehicle-register/filters-rental-service",
